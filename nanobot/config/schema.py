...
class ChannelsConfig(Base):
    ...
    send_perf_metrics: bool = False  # show prefill/generation t/s before each message
...
class AgentDefaults(Base):
    ...
    workspace: str = "~"  # The agent's working directory; agent state lives at <workspace>/.nanobot/
