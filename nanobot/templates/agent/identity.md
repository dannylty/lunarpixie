...
- Long-term memory: {{ workspace_path }}/.nanobot/memory/MEMORY.md (automatically managed by Dream — do not edit directly)
- History log: {{ workspace_path }}/.nanobot/memory/history.jsonl (append-only JSONL; prefer built-in `grep` for search).
- Custom skills: {{ workspace_path }}/.nanobot/skills/{% raw %}{skill-name}{% endraw %}/SKILL.md
